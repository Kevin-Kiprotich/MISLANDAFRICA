...
class Ui_DlgCalculate(object):
    def setupUi(self, DlgCalculate):
        ...
        self.pushButton_vegetation = QtWidgets.QPushButton(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_vegetation.sizePolicy().hasHeightForWidth())
        self.pushButton_vegetation.setSizePolicy(sizePolicy)
        self.pushButton_vegetation.setMinimumSize(QtCore.QSize(0, 48))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.pushButton_vegetation.setFont(font)
        self.pushButton_vegetation.setObjectName("pushButton_vegetation")
        self.verticalLayout_2.addWidget(self.pushButton_vegetation)
...
"(SDG indicator 15.3.1)"))
        self.pushButton_vegetation.setText(_translate("DlgCalculate", "Vegetation Loss/Gain\n"
...
"(CQI, SQI, LMSQI and VQI)"))
        self.pushbutton_CE.setText(_translate("DlgCalculate", "Coastal Erosion (Coastal Vulnerability Index)"))
        self.pushButton_SE.setText(_translate("DlgCalculate", "Soil Erosion (Wind & Water Erosion)"))
